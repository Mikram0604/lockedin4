          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div className="flex flex-col">
                <span className="text-sm font-semibold text-slate-900">Student Profile</span>
                <span className="text-xs text-slate-500 font-medium">+91 {localStorage.getItem("studentPhone")}</span>
              </div>
            </div>
